...
bool CPython::GetItemInfo(ItemInfo* p)
{
	...
	p->iFlags = 0;
	p->iSlot = /*1;*/     GetWeaponMenuColumn(WEAPON_PYTHON);  // nMod
	p->iPosition = /*1;*/ GetWeaponMenuRow(WEAPON_PYTHON); // nMod
...
void CPython::PrimaryAttack()
{
	...
	m_pPlayer->pev->punchangle.x -= GetWeaponRecoil(/*m_pPlayer, */WEAPON_PYTHON); // nMod
	...
	Vector vecDir;
	vecDir = m_pPlayer->FireBulletsPlayer(1, vecSrc, vecAiming, GetAccuracy(m_pPlayer, m_iId), 8192, BULLET_PLAYER_357, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed); // nMod - was originally VECTOR_CONE_1DEGREES  // also changed tracerFreq from 0 to 20
