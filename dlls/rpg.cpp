...
bool CRpg::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "rockets";
	p->iMaxAmmo1 = ROCKET_MAX_CARRY; //GetMaxCarry(WEAPON_RPG, SKILL_WEAPONS_EXPLOSIVE); // nMod;
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = RPG_MAX_CLIP;
	p->iSlot = /*3;*/     GetWeaponMenuColumn(WEAPON_RPG);  // nMod
	p->iPosition = /*0;*/ GetWeaponMenuRow(WEAPON_RPG); // nMod
