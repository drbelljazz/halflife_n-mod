...
void CMP5::Precache()
{
	...
	PRECACHE_SOUND("weapons/mp5-1.wav"); // nMod: CS MP5 sound
	PRECACHE_SOUND("weapons/mp5-2.wav"); // nMod: CS MP5 sound
...
bool CMP5::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "9mm";
	p->iMaxAmmo1 = _9MM_MAX_CARRY;  //	GetMaxCarry(WEAPON_MP5, SKILL_WEAPONS_BULLET); // nMod;
	p->pszAmmo2 = "ARgrenades";
	p->iMaxAmmo2 = M203_GRENADE_MAX_CARRY;
	p->iMaxClip = MP5_MAX_CLIP;
	p->iSlot = /*2;*/     GetWeaponMenuColumn(WEAPON_MP5);     // nMod
	p->iPosition = /*0;*/ GetWeaponMenuRow(WEAPON_MP5); // nMod
	p->iFlags = 0;
...
void CMP5::PrimaryAttack()
{
	...
	m_pPlayer->pev->punchangle.x -= GetWeaponRecoil(/*m_pPlayer,*/ WEAPON_MP5); // nMod
	...
	else
	{
		...
		vecDir = m_pPlayer->FireBulletsPlayer(1, vecSrc, vecAiming, GetAccuracy(m_pPlayer, m_iId), 8192, BULLET_PLAYER_MP5, 2, 0, m_pPlayer->pev, m_pPlayer->random_seed);  // nMod was VECTOR_CONE_3DEGREES  // also changed tracerFreq from 0 to 20
	}
