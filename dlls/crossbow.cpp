...
bool CCrossbow::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "bolts";
	p->iMaxAmmo1 = BOLT_MAX_CARRY; //GetMaxCarry(WEAPON_CROSSBOW, SKILL_WEAPONS_BULLET); // nMod
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = CROSSBOW_MAX_CLIP;
	p->iSlot = /*2;*/ GetWeaponMenuColumn(WEAPON_CROSSBOW); // nMod
	p->iPosition = /*2;*/ GetWeaponMenuRow(WEAPON_CROSSBOW);    // nMod
