...
//#include "nanomod.h"   // TODO: make hud battery max out at current skill-based limit
...
bool CHudBattery::Draw(float flTime)
{
	...
	rc.top += m_iHeight * ((float)(200 - (V_min(200, m_iBat))) * 0.005); // battery can go from 0 to 100 so * 0.01 goes from 0 to 1
