...
// nModmod CVARs
cvar_t nano_killsequence = {"killsequence", "1", FCVAR_SERVER}; 
cvar_t nano_showaccuracy = {"showaccuracy", "0", FCVAR_SERVER};
cvar_t nano_gibcount = {"gibcount", "6", FCVAR_SERVER};			
cvar_t nano_monsterfaker = {"monsterfaker", "1", FCVAR_SERVER};		
cvar_t nano_showxp = {"showxp", "0", FCVAR_SERVER};				
cvar_t nano_monstermakerfade = {"mmfadeout", "1", FCVAR_SERVER};	
cvar_t nano_newweapons = {"nano_weapons", "1", FCVAR_SERVER};
cvar_t nano_newweaponmenu = {"nano_weaponmenu", "1", FCVAR_SERVER};
cvar_t nano_hordemode = {"hordemode", "0", FCVAR_SERVER};
cvar_t nano_showinventory = {"inventory_visible", "0", FCVAR_SERVER};
//cvar_t nano_crosshairmode = {"altcrosshair", "0", FCVAR_SERVER};

cvar_t nano_bulletskill = {"skill_weapons_bullet", "0", FCVAR_SERVER}; 
cvar_t nano_specializedskill = {"skill_weapons_special", "0", FCVAR_SERVER};		
cvar_t nano_firmwareskill = {"skill_firmware", "0", FCVAR_SERVER};			
cvar_t nano_legsskill = {"skill_legs", "0", FCVAR_SERVER};
cvar_t nano_armsskill = {"skill_arms", "0", FCVAR_SERVER};
cvar_t nano_torsoskill = {"skill_torso", "0", FCVAR_SERVER};
cvar_t nano_headskill = {"skill_head", "0", FCVAR_SERVER};
cvar_t nano_stealthskill = {"skill_stealth", "0", FCVAR_SERVER};				
cvar_t nano_resistanceskill = {"skill_hazard", "0", FCVAR_SERVER};		
cvar_t nano_timeskill = {"skill_time", "0", FCVAR_SERVER};		
...
void GameDLLInit()
{
	...
	// nModmod CVARs
	CVAR_REGISTER(&nano_killsequence); 
	CVAR_REGISTER(&nano_showaccuracy); 
	CVAR_REGISTER(&nano_gibcount); 
	CVAR_REGISTER(&nano_monsterfaker);	   
	CVAR_REGISTER(&nano_showxp);	 
	CVAR_REGISTER(&nano_monstermakerfade);
	CVAR_REGISTER(&nano_newweapons);
	CVAR_REGISTER(&nano_newweaponmenu);
	CVAR_REGISTER(&nano_hordemode);
	CVAR_REGISTER(&nano_showinventory);
	//CVAR_REGISTER(&nano_crosshairmode);
	CVAR_REGISTER(&nano_bulletskill); 
	CVAR_REGISTER(&nano_specializedskill);	   
	CVAR_REGISTER(&nano_legsskill); 
	CVAR_REGISTER(&nano_armsskill);	   
	CVAR_REGISTER(&nano_stealthskill); 
	CVAR_REGISTER(&nano_torsoskill);	   
	CVAR_REGISTER(&nano_headskill);	
	CVAR_REGISTER(&nano_timeskill);	
	CVAR_REGISTER(&nano_resistanceskill);	
	CVAR_REGISTER(&nano_firmwareskill);	   
