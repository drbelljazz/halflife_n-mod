...
bool CHandGrenade::GetItemInfo(ItemInfo* p)
{
	...
	p->iMaxAmmo1 = HANDGRENADE_MAX_CARRY;  //GetMaxCarry(WEAPON_HANDGRENADE, SKILL_WEAPONS_EXPLOSIVE); // nMod
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = WEAPON_NOCLIP;
	p->iSlot = /*4;*/     GetWeaponMenuColumn(WEAPON_HANDGRENADE);  // nMod
	p->iPosition = /*0;*/ GetWeaponMenuRow(WEAPON_HANDGRENADE); // nMod
...
void CHandGrenade::WeaponIdle()
{
	...
	if (0 != m_flStartThrow)
	{
		...
		/*static*/ float flMultiplier/* = 6.5f*/;  // nMod: removed static and assigned value

		flMultiplier = ThrowStrength(WEAPON_HANDGRENADE);  // nMod
