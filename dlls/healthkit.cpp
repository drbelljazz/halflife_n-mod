...
bool CHealthKit::MyTouch(CBasePlayer* pPlayer)
{
	...
	// Nano: butchered this to involve the inventory system
	...
	else if (pPlayer->pev->health + gSkillData.healthkitCapacity > pPlayer->pev->max_health)
	{
		MESSAGE_BEGIN(MSG_ONE, gmsgItemPickup, NULL, pPlayer->pev);
		WRITE_STRING(STRING(pev->classname));
		MESSAGE_END();
		...
		nMod.Inventory[ITEM_MEDKIT] += 1;  // Add to inventory for later

		ClientPrint(pPlayer->pev, HUD_PRINTCENTER , "MEDKIT ADDED TO INVENTORY!");
