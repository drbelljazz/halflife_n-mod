...
bool CEgon::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "uranium";
	p->iMaxAmmo1 = URANIUM_MAX_CARRY; //GetMaxCarry(WEAPON_EGON, SKILL_WEAPONS_ENERGY); // nMod
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = WEAPON_NOCLIP;
	p->iSlot = /*3;*/		GetWeaponMenuColumn(WEAPON_EGON);   // nMod
	p->iPosition = /*2;*/   GetWeaponMenuRow(WEAPON_EGON);  // nMod
...
void CEgon::PrimaryAttack()
{
	...
	//Print("WIDE FIRE!", print_center);  // nMod
}

void CEgon::SecondaryAttack() // nMod addition
{
	m_fireMode = FIRE_NARROW;
	Attack();

	//Print("NARROW FIRE!", print_center); // nMod
}
...
void CEgon::Fire(const Vector& vecOrigSrc, const Vector& vecDir)
{
	...
	m_pPlayer->pev->punchangle.x -= GetWeaponRecoil(/*m_pPlayer, */WEAPON_EGON); // nMod
