...
bool CHgun::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "Hornets";
	p->iMaxAmmo1 = HORNET_MAX_CARRY; //GetMaxCarry(WEAPON_HORNETGUN, SKILL_WEAPONS_ALIEN); // nMod
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = WEAPON_NOCLIP;
	p->iSlot = /*3;*/     GetWeaponMenuColumn(WEAPON_HORNETGUN);   // nMod
	p->iPosition = /*3;*/ GetWeaponMenuRow(WEAPON_HORNETGUN);  // nMod
