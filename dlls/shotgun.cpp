...
bool CShotgun::GetItemInfo(ItemInfo* p)
{
	...
	p->pszAmmo1 = "buckshot";
	p->iMaxAmmo1 = BUCKSHOT_MAX_CARRY;  //GetMaxCarry(WEAPON_SHOTGUN, SKILL_WEAPONS_BULLET); // nMod;
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = SHOTGUN_MAX_CLIP;
	p->iSlot = /*2;*/ GetWeaponMenuColumn(WEAPON_SHOTGUN);   // nMod
	p->iPosition = /*1;*/ GetWeaponMenuRow(WEAPON_SHOTGUN);  // nMod
	p->iFlags = 0;
...
void CShotgun::PrimaryAttack()
{
	...
	m_pPlayer->pev->punchangle.x -= GetWeaponRecoil(WEAPON_SHOTGUN); // nMod
	...
	else
	{
		...
		vecDir = m_pPlayer->FireBulletsPlayer(6, vecSrc, vecAiming, GetAccuracy(m_pPlayer, m_iId), GetShotgunDistance(), BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed);  // nMod: was VECTOR_CONE_10DEGREES
	}
