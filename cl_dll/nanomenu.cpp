...
//-----------------------------------------------------------------------------
// UpgradePanel::HitTestPanel.
//-----------------------------------------------------------------------------

void UpgradePanel::HitTestPanel::internalMousePressed(MouseCode code)
{
...
//-----------------------------------------------------------------------------
UpgradePanel::UpgradePanel(int x, int y, int wide, int tall) : Panel(x, y, wide, tall)
{
...
void UpgradePanel::Update()
{
	...
	if (gViewPort->m_szServerName)
	{
		...
		sprintf(sz, "NanoMod Upgrade Menu");
...
//-----------------------------------------------------------------------------
void UpgradePanel::SortPlayers(int iTeam, char* team)
{
...
//-----------------------------------------------------------------------------
void UpgradePanel::RebuildTeams()
{
...
//-----------------------------------------------------------------------------
void UpgradePanel::DeathMsg(int killer, int victim)
{
...
void UpgradePanel::mousePressed(MouseCode code, Panel* panel)
{
...
void UpgradePanel::cursorMoved(int x, int y, Panel* panel)
{
	if (GetClientVoiceMgr()->IsInSquelchMode())
	{
...
//			col -
//-----------------------------------------------------------------------------
void UpgradePanel::MouseOverCell(int row, int col)
{
