...
{
	// nMod: with advanced skill level, grenades make the bounce sound from Quake
	//if (GetSkillLevel(SKILL_WEAPONS_EXPLOSIVE) == SKILL_ADVANCED)
	{
		g_engfuncs.pfnEmitSound(ENT(pev), CHAN_VOICE, "bounce.wav", 0.5, ATTN_NORM, 0, 97 + g_engfuncs.pfnRandomLong(0, 3));
		return;
	}
