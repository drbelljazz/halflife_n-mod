...
bool CTripmine::GetItemInfo(ItemInfo* p)
{
	...
	p->iMaxAmmo1 = TRIPMINE_MAX_CARRY; //GetMaxCarry(WEAPON_TRIPMINE, SKILL_WEAPONS_EXPLOSIVE); // nMod
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
	p->iMaxClip = WEAPON_NOCLIP;
	p->iSlot = /*4;*/      GetWeaponMenuColumn(WEAPON_TRIPMINE); // nMod
	p->iPosition = /*2;*/  GetWeaponMenuRow(WEAPON_TRIPMINE); // nMod
