...
//#define NANO_PLAYERSPEED_ADJUSTMENT 1.7 // nMod
#define NANO_MAXSPEED 600
#define NANO_WALKKEYSPEED 0.1
...
void InitInput()
{
	...
	cl_upspeed = gEngfuncs.pfnRegisterVariable("cl_upspeed", "320", 0);  // jump speed
