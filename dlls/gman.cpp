...
int CGMan::Classify()
{
	return CLASS_HUMAN_PASSIVE;  // nMod
}
...
void CGMan::Spawn()
{
	...
	m_bloodColor = BLOOD_COLOR_RED; // nMod
	pev->health = 10; // nMod: was 100
	m_flFieldOfView = 0.5; // indicates the width of this monster's forward view cone ( as a dotproduct result )
	m_MonsterState = MONSTERSTATE_NONE;

	pev->takedamage = 1; // nMod
	MonsterInit();
}
...
void CGMan::Precache()
{
	...
	PRECACHE_MODEL("models/nanomod/gmandm.mdl");  // nMod
	PRECACHE_SOUND("barney/ba_die1.wav");	 // nMod
}
