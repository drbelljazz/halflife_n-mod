...
//#define MAX_NORMAL_BATTERY 100   // nMod: using out GetMaxCharge() function instead
...
#define VECTOR_CONE_11DEGREES Vector(0.09629, 0.09629, 0.09629)
#define VECTOR_CONE_12DEGREES Vector(0.10510, 0.10510, 0.10510)
#define VECTOR_CONE_13DEGREES Vector(0.11394, 0.11394, 0.11394)
#define VECTOR_CONE_14DEGREES Vector(0.12278, 0.12278, 0.12278)
#define VECTOR_CONE_15DEGREES Vector(0.13053, 0.13053, 0.13053)
#define VECTOR_CONE_16DEGREES Vector(0.14054, 0.14054, 0.14054)
#define VECTOR_CONE_17DEGREES Vector(0.14945, 0.14945, 0.14945)
#define VECTOR_CONE_18DEGREES Vector(0.15838, 0.15838, 0.15838)
#define VECTOR_CONE_19DEGREES Vector(0.16734, 0.16734, 0.16734)
...
public:
	...
	void PrimaryAttack() override;
	void SecondaryAttack() override;
	bool GlockFire(Vector vector_Spread, float flCycleTime, bool fUseAutoAim); // nMod: changed first parameter to Vector
	//void FireAgain();  // nMod
	bool Deploy() override;
	void Reload() override;
	void WeaponIdle() override;
...
public:
	...
	void EXPORT NormalSwingAgain();
	void EXPORT HeavySwingAgain();
	void EXPORT Smack();
	bool GetItemInfo(ItemInfo* p) override;

	void PrimaryAttack() override;
	void SecondaryAttack() override;  // nMod
	bool SwingNormal(bool fFirst);	 // nMod
	bool SwingHeavy(bool fFirst);	 // nMod
	bool Deploy() override;
	void Holster() override;
	int m_iSwing;
	TraceResult m_trHit;
...
private:
	...
	//unsigned short m_usPipewrench2;
};
...
class CPistolTMP : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
